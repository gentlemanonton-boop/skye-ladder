...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative">
      {/* Header */}
      <header className="sticky top-0 z-20 glass border-b border-white/5" style={{ borderRadius: 0 }}>
      ...
      {/* Tab bar */}
      <div className="sticky top-14 sm:top-16 z-10 glass border-b border-white/5" style={{ borderRadius: 0 }}>
      ...
      <main className={`mx-auto px-4 sm:px-5 pt-6 sm:pt-8 pb-16 space-y-5 sm:space-y-6 ${tab === "discover" ? "max-w-5xl" : "max-w-2xl"}`}>
        {/* removed max-w-5xl for world tab since it's gone */}
        {loading ? (

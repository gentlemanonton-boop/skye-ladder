                  ...
                  <div className="relative rounded-2xl border backdrop-blur-md px-3 py-2.5 sm:px-4 sm:py-3 min-w-[108px] max-w-[140px] sm:min-w-[130px] sm:max-w-[180px]" style={{
                    ...
                    {(token.website || token.twitter || token.telegram || token.discord) && (
                      <div className="flex items-center gap-2 mt-2 pt-2 border-t border-white/10">
                        {token.website && (
                          <a href={safeUrl(token.website)} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} className="text-white/40 hover:text-white/80 transition-colors">
                        ...
                        {token.twitter && (
                          <a href={safeUrl(token.twitter)} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} className="text-white/40 hover:text-white/80 transition-colors">
                            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                          </a>
                        )}
                        {token.telegram && (
                          <a href={safeUrl(token.telegram)} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} className="text-white/40 hover:text-white/80 transition-colors">
                        ...
                        {token.discord && (
                          <a href={safeUrl(token.discord)} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} className="text-white/40 hover:text-white/80 transition-colors">
